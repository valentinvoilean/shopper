	  ...
	  _createClass(_class, [{
	    ...
	    value: function _preventLinkOnFirstClick(e) {
	      ...
	      if (this.$el.hasClass(_shared.SHARED_CLASSES.active)) {
	        ...
	        this.$el.find('.myAccount__leftSide').addClass(_shared.SHARED_CLASSES.animate).one('transitionend', function () {
	          _this.$el.find('.myAccount__rightSide').find('.myAccount__link').addClass(_shared.SHARED_CLASSES.animate).removeClass(_shared.SHARED_CLASSES.expanded);
	        }).addClass(_shared.SHARED_CLASSES.expanded);
	      }
	    }
	  }, {
	    key: '_resetClasses',
	      ...
	      && this.$el.has(e.target).length === 0) // ... nor a descendant of the container
	        {
	          this.$el.find('.myAccount__leftSide').one('transitionend', function () {
	            _this2.$el.find('.myAccount__rightSide').find('.myAccount__link').addClass(_shared.SHARED_CLASSES.expanded);

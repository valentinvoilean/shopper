	...
	var AppComponent = function () {
	  ...
	  _createClass(AppComponent, [{
	    ...
	    value: function init($container) {
	      ...
	      var deepScan = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TopHeaderWishListComponent = function () {
	  function TopHeaderWishListComponent($el) {
	    ...
	    this.$counter = $el.find(_topHeaderWishList.CLASSES.counter);
	    this.$image = $el.find(_topHeaderWishList.CLASSES.image);
	  ...
	  _createClass(TopHeaderWishListComponent, [{
	    ...
	    value: function _addEventHandlers() {
	      ...
	      this.$counter.on('update' + _topHeaderWishList.EVENT_NAMESPACE, $.proxy(this._updateCounter, this));
	    }
	  }, {
	    key: '_removeEventHandlers',
	    value: function _removeEventHandlers() {
	    ...
	    key: '_updateCounter',
	    value: function _updateCounter(e, data) {
	      this.$counter.html(data.counter > 0 ? data.counter : '');
	      this.$image.toggleClass(_shared.SHARED_CLASSES.active, data.counter > 0);
	    }
	  }, {
	    key: '_activateItem',
	    value: function _activateItem(e) {
...
/***/ function(module, exports) {
	...
	var NAMESPACE = exports.NAMESPACE = '.wishList';
	...
	var WishListComponent = function () {
	  ...
	  _createClass(WishListComponent, [{
	    ...
	    value: function addEventListeners() {
	      $(document).on('click' + _wishList.NAMESPACE, _wishList.CLASSES.button, $.proxy(this._postToWishlist, this));
	      $(document).on('click' + _wishList.NAMESPACE, _wishList.CLASSES.removeButton, $.proxy(this._removeFromWishlist, this));
	      $(document).on('click' + _wishList.NAMESPACE, _wishList.CLASSES.addToCart, $.proxy(this._addToCart, this));
	    }
	  }, {
	    key: 'removeEventListeners',
	    value: function removeEventListeners() {
	      $(document).off(_wishList.NAMESPACE);
	    }
	  }, {
	    key: '_postToWishlist',
	    value: function _postToWishlist(e) {
	      ...
	      $.post('/contact', [{ name: 'form_type', value: 'customer' }, { name: 'contact[email]', value: options['email'] }, { name: 'contact[tags]', value: options['tagID'] }]).done(this._updateCounter).fail(function () {
	        return console.warn('Can not add item to wishlist!');
	      });
	    }
	  }, {
	    ...
	    value: function _removeFromWishlist(e) {
	      ...
	      $.post('/contact', [{ name: 'form_type', value: 'customer' }, { name: 'contact[email]', value: options['email'] }, { name: 'contact[tags]', value: options['tagID'] }]).done(function (data) {
	        _this._updateCounter(data);
	        $currentProduct.remove();
	
	        if ($wishList.children('li').length) {
	          _this._updateEmailList();
	        } else {
	          $('#wishlist-email-link').empty().html('<p>Your wish list is currently empty.</p>');
	        }
	      }).fail(function () {
	        return console.warn('Can not remove item from wishlist!');
	      }).always(function () {
	        $currentProduct = null;
	        $button = null;
	        $wishList = null;
	    ...
	    key: '_updateCounter',
	    value: function _updateCounter(data) {
	      var counter = parseInt($(data).find(_wishList.CLASSES.counter).text());
	      $(_wishList.CLASSES.counter).trigger('update', { counter: counter });
	    }
	  }, {
	    key: '_addToCart',
	    value: function _addToCart(e) {
	      ...
	      $.post('/cart/add', [{ name: 'id', value: options['variantID'] }]).done(function () {
	        _this2._removeFromWishlist(e);
	        console.warn('Product added to cart !');
	      }).fail(function () {
	        return console.warn('Can not add variant to cart!');
	      }).always(function () {
	        $currentProduct = null;
	        $button = null;
	      });
	    ...
	    value: function _updateEmailList() {
	      ...
	      $.get(currentURL).done(function (data) {
	        var newEmailLink = $(data).find(_wishList.CLASSES.email);
	        $(_wishList.CLASSES.email).html(newEmailLink);
	        newEmailLink = null;
	      }).fail(function () {
	        return console.warn('Can not update email list!');
	      });
	    }
	  }, {
	    key: 'selectCallback',
	    value: function selectCallback(variant) {
	      var $wishListProduct = $(_wishList.CLASSES.product),
	      ...
	      $.get(newURL).done(function (data) {
	        ...
	        var newData = $(data).find(_wishList.CLASSES.product).html();
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,